...
async def settings_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "photos":
        ...
        await query.edit_message_text(
            ...
            "Admin only. Creates a complete backup file.",
            parse_mode="Markdown"
        )
...
async def post_init(application: Application):
    ...
    await application.bot.set_my_commands([
        ...
        BotCommand("getbysize", "View a collection sorted by file size"),
        ...
        BotCommand("settings", "Toggle photos, files, minlength, etc."),
    ])
